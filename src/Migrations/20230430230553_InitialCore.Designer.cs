...
namespace src.Migrations
{
    ...
    [Migration("20230430230553_InitialCore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyMate.EventCourse", b =>
                {
                    b.Property<string>("EventId")
                        .HasColumnType("NVARCHAR2(450)");
            ...
            modelBuilder.Entity("StudyMate.EventProfile", b =>
                {
                    b.Property<string>("EventId")
                        .HasColumnType("NVARCHAR2(450)");
            ...
            modelBuilder.Entity("StudyMate.Profile", b =>
                {
                    ...
                    b.Property<string>("EventCalendarEventId")
                        .HasColumnType("NVARCHAR2(450)");
                    ...
                    b.HasIndex("EventCalendarEventId");
            ...
            modelBuilder.Entity("StudyMate.EventCourse", b =>
                {
                    b.HasOne("StudyMate.Course", "Course")
                        .WithMany("EventCourse")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudyMate.EventCalendar", "EventCalendar")
                        .WithMany("EventCourse")
            ...
            modelBuilder.Entity("StudyMate.Profile", b =>
                {
                    b.HasOne("StudyMate.EventCalendar", null)
                        ...
                        .HasForeignKey("EventCalendarEventId");
