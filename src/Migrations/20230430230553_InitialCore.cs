    ...
    public partial class InitialCore : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventCourses", x => new { x.EventId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_EventCourses_StudyCourses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "StudyCourses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventProfiles", x => new { x.EventId, x.ProfileId });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventCourses_CourseId",
                table: "EventCourses",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_EventProfiles_ProfileId",
                table: "EventProfiles",
                column: "ProfileId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_EventProfiles_Events_EventId",
                table: "EventProfiles",
                column: "EventId",
                principalTable: "Events",
                principalColumn: "EventId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_EventProfiles_Profiles_ProfileId",
                table: "EventProfiles",
                column: "ProfileId",
                principalTable: "Profiles",
                principalColumn: "ProfileId",
