 namespace StudyMate
 {
     ...
     public class Application{
        ...
        public static void Main(string[] args){
            ...
            //Users
            User creator = new User("Sam", "sam@hotmail.com", "password1");
            User participant = new User("Jack", "jack@hotmail.com", "password2");
            //Profiles
            Profile creator_profile = new Profile("Sam", 20, sch2,"Education", new List<NeedHelpCourses>(){new NeedHelpCourses(Courses.Art)}, creator);
            Profile participant_profile = new Profile("Jack", 18, sch3,"Sports studies", new List<NeedHelpCourses>(){new NeedHelpCourses(Courses.Calculus)}, participant);
            //Profile list
            List<Profile> profileList = new List<Profile>();
            profileList.Add(profile1);
            profileList.Add(participant_profile);
            ...
            //Act
            EventCalendar eC = new EventCalendar("Study event", creator_profile, profileList, dTime, description, school, eventCourses, location, sent);
